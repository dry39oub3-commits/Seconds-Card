...
async function checkAuthAndLoadData() {
    ...
    // ✅ إذا لم يكن لديه رقم هاتف — حوّله لصفحة البروفيل أولاً
    if (!phone) {
        document.body.innerHTML = `
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
            <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;
                ...
                <div style="font-size:80px;">📱</div>
                <h1 style="color:#f97316;font-size:26px;">أضف رقم هاتفك أولاً</h1>
                <p style="color:#94a3b8;font-size:15px;max-width:400px;line-height:2;">
                    يجب إضافة رقم هاتفك في صفحة الملف الشخصي قبل تفعيل حسابك وإتمام عمليات الشراء.
                </p>
                <a href="profile.html"
                   style="display:inline-flex;align-items:center;gap:10px;
                          background:#f97316;color:white;padding:14px 32px;
                          border-radius:12px;text-decoration:none;font-size:16px;font-weight:bold;">
                    <i class="fas fa-user"></i> اذهب لصفحة الملف الشخصي
                </a>
    ...
    // ✅ لديه رقم هاتف — أرسله لواتساب للتفعيل
